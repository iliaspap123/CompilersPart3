...
define i1 @Tree.Compare(i8* %this, i32 %.num1, i32 %.num2) {
	...
	br i1 %_4, label %if0, label %else0
if0:
	store i1 0, i1* %ntb
...
%_8 = xor i1 1, %_7
	br i1 %_8, label %if1, label %else1
if1:
	store i1 0, i1* %ntb
...
loopStart0:
	...
	br i1 %_21, label %if2, label %else2
if2:
	...
	br i1 %_28, label %if3, label %else3
if3:
...
else2:
	...
	br i1 %_57, label %if4, label %else4
if4:
...
loopInit1:
	%_0 = load i1, i1* %cont
	br i1 %_0, label %loopStart1, label %loopEnd1
loopStart1:
	...
	br i1 %_10, label %if5, label %else5
if5:
	...
	br i1 %_17, label %if6, label %else6
if6:
...
else5:
	...
	br i1 %_28, label %if7, label %else7
if7:
	%_29 = load i8*, i8** %current_node
	; Tree.GetHas_Right: 7
	%_30 = bitcast i8* %_29 to i8***
	...
	br i1 %_35, label %if8, label %else8
if8:
	%_36 = load i8*, i8** %current_node
...
else7:
	...
	br i1 %_44, label %if9, label %else9
if9:
...
%_52 = xor i1 1, %_51
	br label %andStart10
	andStart10:
	br i1 %_52, label %andclause10, label %andclause12
andclause10:
...
andclause12:
%_61 = phi i1 [ 0,%andStart10], [ %_60, %andclause11]
	br i1 %_61, label %if10, label %else10
if10:
	store i1 1, i1* %ntb
...
define i1 @Tree.Remove(i8* %this, i8* %.p_node, i8* %.c_node) {
	...
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %if11, label %else11
if11:
	; Tree.RemoveLeft: 16
...
else11:
	...
	br i1 %_21, label %if12, label %else12
if12:
	; Tree.RemoveRight: 15
...
else12:
	...
	br i1 %_57, label %if13, label %else13
if13:
...
loopInit2:
	...
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %loopStart2, label %loopEnd2
loopStart2:
...
loopInit3:
	...
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %loopStart3, label %loopEnd3
loopStart3:
	%_7 = load i8*, i8** %c_node
	; Tree.SetKey: 6
	%_8 = bitcast i8* %_7 to i8***
...
loopInit4:
	%_0 = load i1, i1* %cont
	br i1 %_0, label %loopStart4, label %loopEnd4
loopStart4:
	%_1 = load i8*, i8** %current_node
	; Tree.GetKey: 5
	%_2 = bitcast i8* %_1 to i8***
	...
	%_9 = load i32, i32* %key_aux
	%_10 = icmp slt i32 %_8, %_9
	br i1 %_10, label %if14, label %else14
if14:
	%_11 = load i8*, i8** %current_node
	; Tree.GetHas_Left: 8
	%_12 = bitcast i8* %_11 to i8***
	...
	%_16 = bitcast i8* %_15 to i1 (i8*)*
	%_17 = call i1 %_16(i8* %_11)
	br i1 %_17, label %if15, label %else15
if15:
	%_18 = load i8*, i8** %current_node
	; Tree.GetLeft: 4
...
else14:
	...
	br i1 %_27, label %if16, label %else16
if16:
	...
	br i1 %_34, label %if17, label %else17
if17:
...
define i1 @Tree.RecPrint(i8* %this, i8* %.node) {
	...
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %if18, label %else18
if18:
	; Tree.RecPrint: 19
	%_7 = bitcast i8* %this to i8***
	%_8 = load i8**, i8*** %_7
...
end18:
	...
	br i1 %_33, label %if19, label %else19
if19:
	; Tree.RecPrint: 19
...
define i32 @Visitor.visit(i8* %this, i8* %.n) {
	...
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %if20, label %else20
if20:
	%_7 = load i8*, i8** %n
	; Tree.GetRight: 3
	%_8 = bitcast i8* %_7 to i8***
...
end20:
	...
	br i1 %_31, label %if21, label %else21
if21:
	%_32 = load i8*, i8** %n
	; Tree.GetLeft: 4
...
define i32 @MyVisitor.visit(i8* %this, i8* %.n) {
	...
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %if22, label %else22
if22:
	%_7 = load i8*, i8** %n
	; Tree.GetRight: 3
	%_8 = bitcast i8* %_7 to i8***
...
end22:
	...
	br i1 %_38, label %if23, label %else23
if23:
	%_39 = load i8*, i8** %n
	; Tree.GetLeft: 4
	%_40 = bitcast i8* %_39 to i8***
